    ...
    return Autocomplete<Location>(
      optionsBuilder: (TextEditingValue textEditingValue) {
        ...
        return _locations.where((Location location) {
          return location.displayName.toLowerCase().contains(
            textEditingValue.text.toLowerCase(),
          );
        });
      },
      displayStringForOption: (Location location) => location.displayName,
      ...
      fieldViewBuilder:
          (
            ...
            if (selectedLocation != null && controller.text.isEmpty) {
              controller.text = selectedLocation.displayName;
            }
    ...
    return DropdownButtonFormField<int>(
      ...
      items: _vehicles.map((vehicle) {
        return DropdownMenuItem<int>(
          value: vehicle.id,
          child: Text(
            '${vehicle.plateNumber} - ${vehicle.vehicleType} (${vehicle.seatCapacity} kursi)',
          ),
        );
      }).toList(),
      onChanged: (value) {
